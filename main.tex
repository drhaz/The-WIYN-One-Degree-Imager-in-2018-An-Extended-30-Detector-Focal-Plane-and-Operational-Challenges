...
science use, reducing the usable science field of view. Insofar, the
...
\begin{figure}
    ...
    the filter arm drive concept with order of 6000 in and out actuation.
...
unreliable because of increased friction, and occasionally bronze shavings caused
...
\caption{\label{fig_straylight} View through the ODI instrument and telescope
    ...
    directly off a reflection off the tertiary mirror. The  lower right arc is
...
acquisition of flat field calibration images the stray light is detrimental.
	...
	\begin{sidewaysfigure} 
		...
		\begin{tabular}{ccccc} odi u' & odi g' & odi r' & od i'
			i & odi z' \\ \hline \multicolumn{5}{c}{ratio of $\pm 90^\circ$ 
				flat

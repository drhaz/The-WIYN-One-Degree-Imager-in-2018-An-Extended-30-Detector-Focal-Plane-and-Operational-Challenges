...
the WIYN 3.5 meter telescope (Kitt Peak, Arizona).  The instrument is designed for a one degree 
square field of view with 64 Orthogonal Transfer Array (OTA) CCD sensor. A first incarnation of ODI 
...
Astronomical Telescopes + Instrumentation conference in 2014\cite{harbeckl2014}. 
...
%%%% References %%%%%
\bibliography{odi} \bibliographystyle{spiejour}

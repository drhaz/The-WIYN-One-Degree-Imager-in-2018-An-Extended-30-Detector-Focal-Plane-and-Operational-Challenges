...
\author[c]{David Ouellete} \author[e]{Eric J. Hooper} \author[b, e]{Michael Smith}
...
3.5 meter telescope at the Kitt Peak Observatory. The focal plane was
expanded by an additional seventeen detectors in spring / summer 2015. The now
...
that is operating faster and at a higher reliability level. Three more filters, a
U band and two narrow band filters were added to the instrument's complement, with
two additional filters currently in procurement. We will
...
field of view with 64 Orthogonal Transfer Array (OTA) CCD sensors. OTA detectors
...
\caption{\label{fig_straylight} View through the ODI instrument and telescope
    ...
    directly off a reflection off the tertiary mirror. The third lower right arc is
...
In advance of pODI's original  deployment, a detailed straylight analysis executed by

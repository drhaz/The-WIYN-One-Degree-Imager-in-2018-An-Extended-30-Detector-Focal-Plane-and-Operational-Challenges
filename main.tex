...
H$\alpha$ filter). We  review the lessons learned during nearly three years
...
\begin{figure}
    ...
    units. Each OTA is comprised of 8  $\times$ 8 cells spanning about 1' $\times$
...
\begin{itemize}
	...
	attribute those to the thermal cycling caused by the nearby CCD controllers. 
...
exposure have their OD turned fully on. This  contaminates large parts of
...
Further details about the instrument performance are described in the ODI User's
...
was designed and built at the University of Wisconsin-Madison (Figure
\ref{fig_filterdrive}, left), and its operation was successfully demonstrated by
over in/out 6000 actuations  under several spatial orientations. After
testing, the worm gear box was taken apart and inspected for signs of excessive
wear - none  could be identified.

Upon successful testing, a full complement of nine filter drives (three units
that serve three filter arms each) was built at
...
The stray light was mitigated by installing two additional baffles  at the telescope
according to Photon Engineering's recommendation: one larger ring baffle
...
While the surface of the dewar window is constantly fed dry air to prevent
...
wittmann2017, lee2018a, lee2018b, lee2018c,   gorsuch2018 }. ODI is typically 
scheduled for 30 to 35 nights per
...
populations in the  Milky Way star clusters, the evolution of dwarf galaxies

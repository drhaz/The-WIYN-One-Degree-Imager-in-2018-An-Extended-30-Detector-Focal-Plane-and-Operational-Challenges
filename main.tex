...
arm mechanism, where a degrading worm-gear mechanism was replaced by a chain drive
that is operating faster and at a higher reliability level.
%Three more filters, a u' band and two narrow band filters were added to the instrument's complement, with
%two additional filters currently in procurement. 
...
for the addition of heaters with a modest machining effort. Other improvements to the dry air system include a redundant air compressor, and an automatic switch over to bottled dry nitrogen, should the dry air system fail.
